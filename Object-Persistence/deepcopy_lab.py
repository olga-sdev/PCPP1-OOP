...
Your input is a list of dictionaries; each dictionary represents one type of candy.
Each type of candy contains a key entitled 'weight', which should lead you to the total weight details of the given delicacy.
...
price_proposal = copy.deepcopy(warehouse)


for item in price_proposal:
    if item['weight'] > 300:
        item['price'] *= 0.8
        print(item)
    else:
